    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none text-foreground/80 space-y-6">
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">I. INTRODUCTION</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">II. PURPOSE</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">III. APPLICATION OF NATIONAL LAWS</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">IV. SCOPE</h2>
            <p>
            ...
            <p>
              Our website is not intended for individuals under 18 years of age, without the valid consent of their parent or guardian. If we learn that we have collected or received personal information from an individual under age 18 without verification of legal guardian or parental consent, we will delete that information. If you believe that we might have any information from or about a child under age 18, please contact us at webmaster@artofliving.org
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">V. DATA COLLECTION</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">VI. USE OF DATA</h2>
            <p><strong>a)</strong> All personal data is stored securely in a manner that reasonably protects it from misuse and loss and from unauthorized access, modification or disclosure.</p>
            <p>
            ...
            <p>
              <strong>c)</strong> In some cases, the collection of data may be a statutory or contractual requirement, and we will be limited in the products and services we can provide you without your consent for us to be able to use such data.
            </p>
            <p>
            ...
            <p>
              <strong>g)</strong> Sensitive Information: Sensitive information as defined under the relevant national data privacy laws, will be used by us only: (i) for the primary purpose for which it was obtained; and/or (ii) with your consent; or where required or authorized by applicable law.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">VII. STORAGE OF DATA</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">VIII. SHARING OF DATA</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">IX. USER OPTIONS</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">X. RIGHT TO WITHDRAW INFORMATION</h2>
            <p>
              <strong>a)</strong> You may access certain areas of our website without providing any data at all. However, to use all features and functions available on our website you may be required to submit or allow for the collection of certain data.
            </p>
            <p>
              <strong>b)</strong> You may restrict your internet browser's use of Cookies. For more information, see our Cookie Policy.
            </p>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XI. ACCESS TO DATA</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XII. SUMMARY RIGHTS</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XIII. AUTOMATED DECISION-MAKING AND PROFILING</h2>
            <p>
            ...
            <p>
              <strong>b)</strong> The right described in the section above does not apply in the following circumstances: (i) the decision is necessary for the entry into, or performance of, a contract between you and us; (ii) the decision is authorized by law; or (iii) you have given your explicit consent.
            </p>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XIV. CONTACT US</h2>
            <p>
              If you have any questions about our website or this Privacy Policy, please contact us by email at webmaster@artofliving.org. Please ensure that your query is clear, particularly if it is a request for information about the data we hold about you.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XV. CHANGES TO THE PRIVACY POLICY</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XVII. LANGUAGE</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">XVIII. APPLICABLE FOR PERSONS FROM THE EUROPEAN ECONOMIC AREA</h2>
            <h3 className="text-xl font-medium text-foreground mb-2"><strong>a) Legal Framework</strong></h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mb-2"><strong>b) EU-US and Swiss-US Privacy Shield frameworks</strong></h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mb-2"><strong>c) Model Contract Clauses</strong></h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-foreground mb-2"><strong>d) DPO</strong></h3>
            <p>
              If, after contacting us, you feel that your concerns have not been addressed to your satisfaction, you can contact our data protection officer ("DPO") at webmaster@artofliving.org.
            </p>
          </section>
        </div>
      </div>
